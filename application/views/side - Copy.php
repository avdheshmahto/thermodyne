...
<li class="profile-info dropdown"><a  data-toggle="dropdown" class="dropdown-toggle" href="<?php echo base_url(); ?>master/Item/dashboar" aria-expanded="false"> <img style="display:none" width="44" class="img-circle avatar" alt="" src="<?=base_url();?>assets/images/man-3.jpg"><strong><?=$this->session->userdata('user_name');?></strong><span class="caret"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>

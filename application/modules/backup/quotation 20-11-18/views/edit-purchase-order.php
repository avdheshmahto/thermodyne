...
if($_GET['id']!='' or $_GET['view']!=''){
	$query=$this->db->query("select * from tbl_purchase_order_hdr where purchaseid='$id' or purchaseid='".$_GET['view']."'");	
	$fetchq=$query->row();
}
...
<!-- Main content -->
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>SalesOrder/manageSalesOrder">Manage Purchase Order </a></li> 
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title"><strong>Update Purchase Order</strong></h4>
...
<th >Term</th>
<th >
<input type="text"  class="form-control" min="0" name="due_date" value="<?php echo $fetchq->due_date;?>" />
</th>
...
<input type="text" name="prd"  onkeyup="getdata()" onClick="getdata()" class="form-control" id="prd" style=" width:230px;"  placeholder=" Search Items..." tabindex="5" >
...
<th><input type="number" step="any" name="saleamnt" id="disAmt" class="form-control"   style="width:70px;"/ ></th>
 <td> 
						 ...
						 <input type="text" id="igst" class="form-control"  onfocus="this.select()" style="width:62px;" readonly></td>
                          <td><input type="text" id="gstTotal" class="form-control"  onfocus="this.select()" style="width:62px;" readonly></td>	
...
<?php
$z=1;
$query_dtl=$this->db->query("select * from tbl_purchase_order_dtl where purchaseid='".$_GET['id']."' or purchaseid='".$_GET['view']."' ");

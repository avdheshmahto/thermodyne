...
<th><input type="text" name="purchase_no" onkeyup="duplicate_po_check(this.value);" class="form-control input-sm"  required <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>></th>
<th><div style="width:100px;">Customer Name</div></th>
<th>
<div class="field">
	<select name="vendor_id" style="width:80%" required id="contact_id_copy" class="form-control input-sm" onChange="document.getElementsByName('contactid')[0].value=this.value;"   <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>>
...
<th>Date</th>
<th>
<input type="date"  class="form-control input-sm" required name="date" value="<?php echo $detail->invoice_date;?>" />
</th>
...
<tr><th valign="top" style="vertical-align:top">Subject</th>
	<th colspan="1" valign="top"  class="form-control" style="width: 40%; vertical-align:top;">
		<input type="text" name="subject"  placeholder="Please Enter Subject  !" class="form-control input-sm"></th>
<th valign="top" style="vertical-align:top;">Contant</th>
<th colspan="1" valign="top"  class="form-control" style="width: 40%;">
		<textarea rows="4" name="contant" style="height:50px;width: 100%;border: 1px solid #dcd9d9;" placeholder="Please Enter Subject  !"></textarea></th>
<th colspan="1"  class="form-control" style="width: 40%;">&nbsp;</th>	
<th colspan="1" valign="top"  class="form-control">&nbsp;</th>		
</thead>
...
<th><input type="number" id="qn" min="1" style="width:70px;"   class="form-control input-sm"></th>

<th><select id="grade" min="1" style="width:120px;"   class="form-control input-sm">
	<option value="">select Grade</option>
	<?php
		$qryGrade=$this->db->query("select * from tbl_category where status='1' and grade IS NOT NULL  group by grade order by grade ASC");
...
<th><input type="text" name="saleamnt" readonly="" id="tot" class="form-control input-sm" style="width:70px;"/ ></th>
<th><input type="text" name="saleamnt" readonly="" id="nettot" class="form-control input-sm"  style="width:70px;"/ ></th>
...
<th style="display: none;">&nbsp;<input style="display:none" type="number" name="total_cgst"  id="total_cgst" step="any" min="1" placeholder="%" class="form-control"></th>
 ...
 <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
     ...
     <button type="button" class="btn btn-sm"  id="QuotationMap">Add</button> <!-- data-dismiss="modal" -->
    </form>
   </div>
  </div>
 </div>

...
<strong>M/s <?=$first_name;?></strong><br />
<?=$city;?><br />
<strong><u><?=$stateName;?></u></strong>
<h3><center><u>Kind Attn: Mr. <?=$first_name;?></u></center></h3><br />
Dear Sir,<br /><br />
<h3><center>Subject: <?=$subject;?></center></h3><br />
<p>
	<?=$contant;?> 
...
<table style="width:100%;">
<tbody>
<?php if(sizeof($key1) > 0) {
 foreach ($dt as  $key3 => $lastchild) {
?>
<tr>
<td width="40%"><?=$key3;?></td>
<td width="60%"><?=$lastchild;?></td>
</tr>
<?php } } ?>
</tbody>
</table>
...
if($pricedetails != ""){
  ...
  // echo "</pre>";
	$i=1;$total = 0;$m=0;
foreach ($pricedetails['quotation'] as $key => $pdt) { ?>
		
<tr>
<td><?=$i++;?></td>
<td><?=$pdt;?></td>
<td><?=$pricedetails['price'][$m];?></td>

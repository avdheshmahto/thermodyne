...
<label>Show
<select name="DataTables_Table_0_length" url="<?=base_url();?>master/Item/manage_item?<?='sku_no='.$_GET['sku_no'].'&category='.$_GET['category'].'&productname='.$_GET['productname'].'&usageunit='.$_GET['usageunit'].'&unitprice_purchase='.$_GET['unitprice_purchase'].'&unitprice_sale='.$_GET['unitprice_sale'];?>" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">

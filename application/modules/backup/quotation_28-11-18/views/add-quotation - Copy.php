...
<th  valign="top"  class="form-control" style="width:8%;">Price;</th>	
  ...
  <td>
	...
	<select name="accessories_cat" required class="form-control" id="accessories_cat" onchange="getaccessoriescat(this)" value="" style="width: 200px;">
  ...
  <td id="accessories_subcat">
	<select name="accessories" required class="form-control" id="accessories" onchange="getaccessories(this)" value="" subcat="" style="width: 230px;">
		<option value="" >----Select Model----</option>
	</select>  </td>	

	<th>Price</th>
<th>
<input type="text"  class="form-control" name="access_price" value="" id="access_price" style="width: 150px;"/>
</th>

	<th>Description</th>
<th>
<input type="text" class="form-control" name="access_descript" value=""  id="access_descript" style="width: 150px;"/>
</th>

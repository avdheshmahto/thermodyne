...
<ul class="table-list">
<li>
<table id="meta" style="width:100%; font-size:11px;">
<tbody>
<tr>
...
<tr>
<td colspan="2"><h3 style="margin:0px 0 0px 0px !important; font-size:11px;">PAYMENT TERMS:</h3></td>
</tr>
<tr>
<td width="3%">&nbsp;</td>
<td width="97%"><ul style="font-size:14px;">
<li style="font-size:11px;">40% plus applicable GST as advance along-with the order</li>
</ul></td>
</tr>
<tr>
<td>&nbsp;</td>
<td><ul>
<li style="font-size:11px;">Balance payment along-with applicable GST against pro-forma invoice prior to dispatch.</li>
</ul></td>
</tr>
<tr>
<td colspan="2"><h3 style="font-size:11px; margin:0px 0 0px 0px !important;">DELIVERY:</h3></td>
</tr>
<tr>
<td colspan="2"><p>10– 12 weeks from the date of receipt of&nbsp;techno-commercial&nbsp;clear order&nbsp;along-withadvance.</p></td>
</tr>
<tr>
<td colspan="2"><h3 style="font-size:11px; margin:0px 0 0px 0px !important;">VALIDITY:</h3></td>
</tr>
<tr>
<td colspan="2"><p>30 days, subject to written confirmation thereafter.</p></td>
</tr>
<tr>
<td colspan="2"><h3 style="font-size:11px; margin:0px 0 0px 0px !important;">WARRANTEE:</h3></td>
</tr>
<tr>

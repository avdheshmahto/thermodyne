...
<label>Show
<select name="DataTables_Table_0_length" url="<?= base_url('master/ProductCategory/manage_itemctg').'?filtername='.$_GET['filtername'].'&filterdate='.$_GET['filterdate'].'&filter='.$_GET['filter'];?>" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">
...
<h4 class="modal-title"><span class="top_title">Add</span>&nbsp;Category</h4>
...
<!-- <div class="form-group">
<label class="col-sm-3 control-label">Select Category type</label> 
<div class="col-sm-6"> 
<select class=" form-control" required name="type" id="type"> 
<option value="1" class="listClass">Product</option>
<option value="2" class="listClass">Quotation </option>
<option value="3" class="listClass">Price </option>
</select>
</div>
</div> -->
<!-- <div class="form-group">
...
<option value="" class="listClass"> -- Select Grade -- </option>
<option value="A" class="listClass"> A </option>
<option value="B" class="listClass"> B </option>
<option value="C" class="listClass"> C </option>
<option value="D" class="listClass"> D </option>
</select>
</div>
</div> -->

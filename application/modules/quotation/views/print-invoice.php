...
<head>
<meta charset="utf-8">
<title><?=$invoiceNo1;?>-<?=$org_name;?>-<?=$contact;?></title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/7.0.0/normalize.min.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/paper-css/0.3.0/paper.css___">
...
<body class="A4">
<div style="margin:auto; width:240mm; margin:auto;">
...
<table style="width:100%; margin:auto; font-size:14px; border:1px solid #000;">
    <tbody>
      <tr style="border:1px solid #000;">
        <td style="border:1px solid #000;">Annexure – I</td>
        <td>Company Profile</td>
      </tr>
      <tr style="border:1px solid #000;">
        <td style="border:1px solid #000;">Annexure – II</td>
        <td>What We Do</td>
      </tr>
      <tr style="border:1px solid #000;">
        <td style="border:1px solid #000;">Annexure – III </td>
        <td>Technical Details</td>
      </tr>
      <tr style="border:1px solid #000;">
        <td style="border:1px solid #000;">Annexure – IV</td>
        <td>Scope of Supply</td>
      </tr>
      <tr style="border:1px solid #000;">
        <td style="border:1px solid #000;">Annexure – V </td>
        <td>Price Schedule</td>
      </tr>
      <tr style="border:1px solid #000;"> 
        <td style="border:1px solid #000;">Annexure – VI</td>
...
<tbody>
<tr>
<td style="background-color:#E1E1E1; padding:5px; height:20px;border: 1px solid;"><center><h3 style="font-size:18px;">Company Profile</h3></center></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <table style="width:100%;">
    <tbody>
      <tr>
        <td style="background-color:#E1E1E1; padding:5px; height:20px;border: 1px solid;"><center>
 ...
 <?php if(sizeof($technical_value) != "") {
    ...
    if (in_array($techDt['grade'], explode(',',$gradevalue)) || $gradevalue == ""){
        ?> 
            ...
            <li><span style= "<?=($p%520)==0?'width:381px;':'';?>"><?=$techDt['name'];?></span>  <span><?=$techDt['value'].'&nbsp;&nbsp;'.$techDt['entity'];?></span></li>
            </ul>
    <?php 
...
<?php 
$sos=$this->db->query("select * from tbl_quotation_order_dtl where quotationid='$quotationid' ");
$getSos=$sos->row();

$ps=$this->db->query("select * from tbl_product_stock where Product_id='$getSos->productid' ");
$getPs=$ps->row();

$tm=$this->db->query("select * from tbl_termandcondition where type='$getPs->category' ");
$getTm=$tm->row();
...
<table id="meta" style="width:100%;">
  ...
  <div style="clear:both;"></div>
	<p><strong>PRICE:</strong><br><?=$priceText;?></p>
  <br />
  <table style="width:100%; margin-bottom:4px; font-size:14px; font-weight:bold;">
  <!--  <tbody>-->
      <tr style="border:1px solid #000;">
        <td width="10%" style="border:1px solid #000;"><strong><h3>S.NO</h3></strong></td>
        <td width="25%" style="border:1px solid #000;"><strong><h3>MODEL</h3></strong></td>
        <td width="65%" colspan="3"><strong><h3>PRICE(Rs)</h3></strong></td>
      </tr>
            <?php 
      if($pricedetails != ""){
        // echo "<pre>";
      ...
      <tr style="border:1px solid #000;">
       <td style="border:1px solid #000;"><?=$i?></strong></td>
       <td style="border:1px solid #000;"><?=$pricedetails['productname'];?></td>
       <td colspan="3"><?=$pricedetails['price1']['price'][$m];?>.00
       <?php if($convertprice != ""){
         $convertprice =  str_replace(',','',$convertprice);
         //echo ;
         echo '('.ucfirst(words_repues($convertprice)).')';
       } ?></td>
      </tr>
	  ...
	  ?>
	     <!-- <tr>
	     <td colspan="4"><p><strong>ACCESSORIES</strong><br></p></td>
	     </tr> -->
       <!-- <tr>
        <td width="33%"><strong><h3>MODEL</h3></strong></td>
        <td width="33%"><strong><h3>PRICE</h3></strong></td>
        <td width="33%"><strong><h3>DESCRIPTION</h3></strong></td>
      </tr>
 -->
        <?php
   ...
   <!--<div class="page-break">16</div>-->

   <table id="meta" style="width:100%; font-size:14px;">
<?php 
    $Query=$this->db->query("select *from tbl_price_schedule_note");
	foreach($Query->result() as $list_data) {
	?>
		<tr>
			<td colspan="2"><?php echo $list_data->note_name;?></td>
		</tr>
...
<tbody>
<tr>
<td style="background-color:#E1E1E1; height:20px;border: 1px solid;"><center>

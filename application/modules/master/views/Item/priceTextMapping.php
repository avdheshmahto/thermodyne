...
<div class="form-group"> 
  <label class="col-sm-2 control-label">Price Title :</label> 
  <div class="col-sm-3" > 
    <input type="text" class="form-control" value=""  id="price_title">
  </div>
  <label class="col-sm-2 control-label">Price Details :</label> 
  <div class="col-sm-3" > 
    <textarea type="text" class="form-control" value="" id="price_details" rows="5" cols="17"></textarea>
  </div>
  <div class="col-sm-2"> 
   <button class="btn btn-default" type="button" onclick="addPriceText()"><img src="/thermodyne/assets/images/plus.png"></button>
  </div>
</div>

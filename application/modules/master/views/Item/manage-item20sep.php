...
<h4 class="modal-title"><span class="top_title">Add</span>&nbsp;Product</h4>
...
<button class="btn btn-default modalEditItem" title="Update Product !" data-a="<?php echo $fetch_list->Product_id;?>" onclick="editItem(this)" href='#editItem' type="button" data-target="#modal-0" data-toggle="modal" data-backdrop='static' data-keyboard='false' arrt= '<?=json_encode($fetch_list);?>'><i class="icon-pencil"></i></button>
...
<!--panel-body panel panel-default close-->

    ...
    private function load($file) {
        if (file_exists($file)) {
            ...
            if ($openedZip === true) {
                ...
                if (($styleIndex = $zip->locateName('word/styles.html')) !== false) {
...
$html = "";  $i=0;
            foreach ($children->body->p as $p) {
                ...
                $html.='<span class="block class'.$i.'" style="' . $style . '">';
                $li = false;
                if ($p->pPr->numPr) {
                    $li = true;
                    $html.='<li>';
                ...
                foreach ($p->r as $part) {
                    ...
                    $html.='<span   style="' . implode(';', $attrs) .';    line-height:1.5;">' . $openTags . $part->t . $closeTags . '</span>';
                }
                if ($li) {
                    $html.='</li>';
                }
